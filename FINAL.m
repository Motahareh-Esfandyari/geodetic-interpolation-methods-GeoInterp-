...
%            (SP3) file. Reads igs13730.sp3 (sp3Cread.m), rotates the
%            ECEF positions to an inertial frame using Earth rotation
%            rate, and interpolates the satellite position at a user-
%            given epoch with cubic splines (CubicSpline.m). Plots the
%            3D orbit and the X/Y/Z components versus time.
%  ------------------------------------------------------------------------
...
[xInt] = CubicSpline(t,xSat,time) ;
[yInt] = CubicSpline(t,ySat,time) ;
[zInt] = CubicSpline(t,zSat,time) ;
