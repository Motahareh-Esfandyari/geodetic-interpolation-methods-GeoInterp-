...
%  ------------------------------------------------------------------------
%  Function: variogram.m   [THIRD-PARTY DEPENDENCY]
%  Purpose : Isotropic/anisotropic experimental (semi-)variogram in
%            various dimensions. Included here as a dependency of
%            KrigingDemo.m.
%  ------------------------------------------------------------------------
%  Author  : Wolfgang Schwanghart (MATLAB File Exchange) - see full
%            documentation and credit below. Used, unmodified, by
%            Motahareh Esfandyari-Kaloukan.
%  ========================================================================

function v = variogram(x,y,varargin)
